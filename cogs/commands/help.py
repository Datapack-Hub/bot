...
HELP = """
Datapack Helper is a utility bot run by **Datapack Hub** to help you with creating datapacks. 
With this bot, teaching people how to create datapacks (as well as making them yourself) is much quicker and easier.
...
Datapack Helper also provides **mcfunction syntax highlighting**. 
Simply send a code block with the `mcfunction` language specified, and it will be automatically coloured with [bth123's highlighter](<https://github.com/bth123/mcf-ansi-highlighter>).
"""
