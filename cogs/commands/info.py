    ...
    async def info(self, inter: disnake.ApplicationCommandInteraction, info: infos):
        if info == "logs default":
            embed = disnake.Embed(
                ...
                title="ℹ️ Default Launcher Logs",
        ...
        if info == "logs other":
            ...
            embed = disnake.Embed(
                color=disnake.Color.orange(),
                title="ℹ️ Datapack Helper <:datapackhelper:1129499893216579614>",
            ...
            embed = disnake.Embed(
                color=disnake.Color.orange(),
                title="ℹ️ Updaing Resourcepacks Past 1.19.3",
